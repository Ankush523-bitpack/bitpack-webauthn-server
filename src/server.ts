...
app.post('/request-challenge', (req, res) => requestChallengeController(req, res, pool));
app.post('/register', (req, res) => registerController(req, res, pool));
app.get('/credentials/:username', (req, res) => credentialUsernameController(req, res, pool));
app.post('/authenticate', (req, res) => authenticationController(req, res, pool));
